...
namespace Chess.Presentation
{
    public class GachaManager : MonoBehaviour
    {
        ...
        public RectTransform pityBarFill;   // PityBarFill RectTransform 연결
        public Button backButton;

        [Header("대기 화면 (WaitingPanel)")]
        public GameObject waitingPanel;
        public Button singlePullButton;
        public Button tenPullButton;

        [Header("카드 공개 연출 (RevealPanel)")]
        public GameObject revealPanel;
        public Transform revealGrid;
        public Button skipButton;

        [Header("결과 확인 (ResultPanel)")]
        ...
        void UpdateHUD()
        {
            ...
            if (gachaSystem != null)
            {
                ...
                // 천장 바 fill (0~1 사이 값으로 anchorMax.x 조정)
                if (pityBarFill != null)
                {
